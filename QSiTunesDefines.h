 ...
 *  iTunesPlugIn
 *
 *  Created by Nicholas Jitkoff on 8/11/07.
...
#define QSiTunesPlaylistIDPrefix @"[iTunes Playlist] :"
#define QSiTunesBrowserIDPrefix @"[iTunes Browser] :"
#define QSiTunesEQIDPrefix @"iTunes Preset:"
